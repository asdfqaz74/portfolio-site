  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="w-[25rem] h-[25rem] perspective">
        ...
        >
          {/* Front Side */}
          <div className="absolute w-full h-full backface-hidden flex flex-col items-center justify-center gap-4 p-4 bg-white dark:bg-neutral-900 rounded-lg shadow-lg">
            <Image
              src={`/${thumbnail}.png`}
